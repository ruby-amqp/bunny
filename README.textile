...
Bunny is a synchronous "AMQP 0.8.0":http://bit.ly/amqp-model-explained client. It supports Ruby 1.9.3, 1.9.2, 1.8.7,
Ruby Enterprise Edition and JRuby.

h2. Limited Functionality Disclaimer

Bunny 0.7.x and 0.8.x releases do not support many features and have serious limitations that may prevent it from
working with future RabbitMQ releases.
...
of AMQP 0.8 version of Bunny is `0.8.0` which is the same as `0.7.9` but hints at the protocol version better.
